package com.santiago.springboot.services.carrroservice.controllers;
...
import com.santiago.springboot.services.carrroservice.services.CarroServices;
...
public class CarroController {
    ...
    // todos los usuarios
    @GetMapping
    private ResponseEntity<List<Carro>> listarCarros() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Carro> obtnerCarro(@PathVariable("id") int id) {
