package com.santigo.springboot.app.usuarioservice.controller;
...
import com.santigo.springboot.app.usuarioservice.service.UsuarioService;
...
public class UsuarioController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Usuario> obtnerUsuario(@PathVariable("id") int id) {
